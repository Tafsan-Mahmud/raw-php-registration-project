...
if(empty($after_assoc_user_data)){
	header('location:/registration_project/log_out.php');
}
...
<head>
	...
	<link rel="stylesheet" href="/registration_project/dashboard_asset/">
    <link href="/registration_project/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/registration_project/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="/registration_project/dashboard_asset/css/style.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <img class="logo-abbr" src="/registration_project/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/registration_project/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/registration_project/dashboard_asset/images/logo-text.png" alt="">
            </a>
            ...
            <div class="header-content">
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
						...
						<li class="nav-item"><a class="nav-link" href="/registration_project/index.php">Home</a></li>
							<li class="nav-item">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="/registration_project/uploads/users/<?=$after_assoc_user_data['image']?>" width="20" alt=""/>
									<div class="header-info">
										<span class="text-black"><strong><?=$after_assoc_user_data['name']?></strong></span>
										<p class="fs-12 mb-0">Super Admin</p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/registration_project/users/profile.php" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/registration_project/log_out.php" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="/registration_project/dashboard.php" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/users/users.php">user list</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/logo/logo.php">Add Logo</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/banners/banner_text.php">Add Banner Text</a></li>
                        </ul>
						<ul aria-expanded="false">
                            <li><a href="/registration_project/banners/banner_img.php">Add Banner image</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/social/social.php">Add icon</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/review/review.php">Add Review</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/contact/contact.php">Add Contact</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Sponsers</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/sponsers/sponsers.php">Add Sponsers</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/about_image/about_image.php">Add About Image</a></li>
                        </ul>
						<ul aria-expanded="false">
                            <li><a href="/registration_project/about_me/about_me.php">Add About</a></li>
                        </ul>
						<ul aria-expanded="false">
                            <li><a href="/registration_project/education/education.php">Add Education</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/messages/messages.php">View Messages</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Fact</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/fact/fact.php">Add Fact</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/services/services.php">Add Services</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/registration_project/work/work.php">Add Work</a></li>
                        </ul>
                    </li>
                </ul>
			</div>
