...
$result_services = mysqli_query($db_connection, $select);
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped table-hover">
                        ...
                        <?php foreach ($result_services as $key => $services) { ?>
                            <tr>
                                <td><?= $key + 1 ?></td>
                                <td><i style="font-family:fontawesome; font-size:30px;" class="<?= $services['icon'] ?>"></i></td>
                                <td><?= $services['name'] ?></td>
                                <td><?= substr($services['desp'],0,20) ?>...</td>
                                <td><a href="services_status.php?id=<?= $services['id'] ?>"><span class="actv-dact-btn badge text-white bg-<?= $services['status'] == 1 ? 'success' : 'secondary' ?>"><?= $services['status'] == 1 ? 'Active' : 'Deactive' ?></span></a></td>
                                <td><a href="delete_services.php?id=<?= $services['id'] ?>" class="btn-delete">Delete</a></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
        ...
        <div class="col-lg-12">
            <form action="services_post.php" method="POST">
                <div class="card pb-4">
                    ...
                    <div class="mb-3 m-3">
                        <label for="exampleInputPassword1" class="form-label">Desp</label>
...
<?php if (isset($_SESSION['service_status_err'])) { ?>
    <script>
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: '<?=$_SESSION['service_status_err']?>!',
        })
    </script>
<?php }
unset($_SESSION['service_status_err']) ?>