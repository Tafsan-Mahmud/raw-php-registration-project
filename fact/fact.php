...
$result_fact = mysqli_query($db_connection, $select);
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-primary ">
                    <h3 class="text-white">Fact List</h3>
                </div>
                <div class="card-body">
                    <table class="table table-striped table-hover">
                        ...
                        <?php foreach ($result_fact as $key => $fact) { ?>
                            <tr>
                                <td><?= $key + 1 ?></td>
                                <td><i style="font-family:fontawesome; font-size:30px;" class="<?= $fact['icon'] ?>"></i></td>
                                <td><?= $fact['count'] ?></td>
                                <td><?= $fact['title'] ?></td>
                                <td><a href="fact_status.php?id=<?= $fact['id'] ?>"><span class="actv-dact-btn badge text-white bg-<?= $fact['status'] == 1 ? 'success' : 'secondary' ?>"><?= $fact['status'] == 1 ? 'Active' : 'Deactive' ?></span></a></td>
                                <td><a href="delete_fact.php?id=<?= $fact['id'] ?>" class="btn-delete">Delete</a></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
        ...
        <div class="col-lg-12">
            <form action="fact_post.php" method="POST">
                <div class="card pb-4">
                    ...
                    <?php if (isset($_SESSION['fact_err'])) { ?>
                        <p class="text-danger ml-3"><?= $_SESSION['fact_err'] ?></p>
                    <?php }
                    unset($_SESSION['fact_err']) ?>
                    <div class="mb-3 m-3">
                        <label for="exampleInputPassword1" class="form-label">Count Number</label>
...
<?php if (isset($_SESSION['fact_status_err'])) { ?>
    <script>
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: '<?=$_SESSION['fact_status_err']?>!',
        })
    </script>
<?php }
unset($_SESSION['fact_status_err']) ?>